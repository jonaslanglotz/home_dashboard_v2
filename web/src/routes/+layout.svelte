<script lang="ts">
  ...
  import { eventsStore, trainDeparturesStore, weatherDataStore } from '$lib/stores'
  import type { WeatherData, Events, TrainDepartures } from '../../../shared-types'

  let ws: WSConnection | undefined
  if (browser) {
    console.debug('Creating new WSConnection Object')
    ws = new WSConnection()
  }
...
{:else}
  <div class="w-screen h-screen flex justify-center items-center">
    <svg
      aria-hidden="true"
      class="mr-2 w-16 h-16 text-gray-100 animate-spin fill-blue-600"
      viewBox="0 0 100 101"
      fill="none"
