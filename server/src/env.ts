...
export const env = readEnv(process.env, {
  ...
  SPOTIFY_OVERLAY: optionalGroup({
    SPOTIFY_OVERLAY_HOME_ASSISTANT_WS_URL: str(),
    SPOTIFY_OVERLAY_HOME_ASSISTANT_TOKEN: str(),
    SPOTIFY_OVERLAY_HOME_ASSISTANT_PRESENCE_ENTITY: str(),
    SPOTIFY_OVERLAY_SPOTIFY_CLIENT_ID: str(),
    SPOTIFY_OVERLAY_SPOTIFY_CLIENT_SECRET: str(),
    SPOTIFY_OVERLAY_SPOTIFY_REFRESH_TOKEN: str(),
    SPOTIFY_OVERLAY_MIN_RESUME_INTERVAL: int()
  })
})
